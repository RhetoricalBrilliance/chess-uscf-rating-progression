...
def rating_progress_by_months_games_and_age(session, uscf_id, dob, total_tournaments_played, date_of_first_tournament, start_rating):
    ...
    date_of_last_tournament = all_classical_tournaments[-1][0]
    years, months, days = months_difference(date_of_first_tournament, date_of_last_tournament)


    return games_played, date_of_last_tournament, years, months, days
...
def scrape(session, uscf_id_list, dob_list):
    ...
    for row_index, (uscf_id, dob) in enumerate(zip(uscf_id_list, dob_list), start=2):
        ...
        games_played, date_of_last_tournament, years, months, days = rating_progress_by_months_games_and_age(session, uscf_id, dob, total_tournaments_played, date_of_first_tournament, initial_rating)

        data_row = [games_played] + [date_of_last_tournament] + [years] + [months] + [days]
        start_column = 6
        ...
        print(f"Date of Last Tournament : {date_of_last_tournament}")
...
if __name__ == '__main__':
    ...
    sheet = client.open("Total Games + Time Played").sheet1
